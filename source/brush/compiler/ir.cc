...
TypeKind parseTypeKind(litestl::util::stringref name)
{
  ...
  if (std::strcmp(s, "void") == 0)
    return TypeKind::Void;
  if (std::strcmp(s, "bool") == 0)
    return TypeKind::Bool;
  if (std::strcmp(s, "int") == 0)
    return TypeKind::Int;
  if (std::strcmp(s, "float") == 0)
    return TypeKind::Float;
  if (std::strcmp(s, "float2") == 0)
    return TypeKind::Float2;
  if (std::strcmp(s, "float3") == 0)
    return TypeKind::Float3;
  if (std::strcmp(s, "float4") == 0)
    return TypeKind::Float4;
  if (std::strcmp(s, "Vertex") == 0)
    return TypeKind::Vertex;
  if (std::strcmp(s, "Face") == 0)
    return TypeKind::Face;
...
{
  const char *s = name.c_str();
  if (std::strcmp(s, "unit") == 0)
    return AttrUseId::Unit;
  if (std::strcmp(s, "color") == 0)
    return AttrUseId::Color;
  if (std::strcmp(s, "uv") == 0)
    return AttrUseId::Uv;
  if (std::strcmp(s, "polygroup") == 0)
    return AttrUseId::Polygroup;
  if (std::strcmp(s, "select") == 0)
    return AttrUseId::Select;
  if (std::strcmp(s, "sculpt_layer") == 0)
    return AttrUseId::SculptLayer;
