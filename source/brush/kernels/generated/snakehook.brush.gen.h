...
static void snakehookPre(CommandCtxBase &ctx, std::span<spatial::SpatialNode *> nodes)
{
...
template <CommandTypes TYPES>
static void snakehookPost(CommandCtxBase &ctx, std::span<spatial::SpatialNode *> nodes)
{
  (void)ctx; (void)nodes;
}
