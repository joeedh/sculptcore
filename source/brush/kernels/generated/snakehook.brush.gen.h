...
static void snakehookPre(CommandCtxBase &ctx,
...
template <CommandTypes TYPES>
static void snakehookPost(CommandCtxBase &ctx,
                          std::span<typename TYPES::node_type *> nodes)
{
  (void)ctx;
  (void)nodes;
...
inline void packSnakehookGpuUniforms(sculptcore::brush::Brush &brush, unsigned char *out)
{
  (void)brush;
  (void)out;
