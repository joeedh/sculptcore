...
static void drawPre(CommandCtxBase &ctx, std::span<typename TYPES::node_type *> nodes)
{
...
template <CommandTypes TYPES>
static void drawPost(CommandCtxBase &ctx, std::span<typename TYPES::node_type *> nodes)
{
  (void)ctx;
  (void)nodes;
}
...
inline void packDrawGpuUniforms(sculptcore::brush::Brush &brush, unsigned char *out)
{
  (void)brush;
  (void)out;
}
