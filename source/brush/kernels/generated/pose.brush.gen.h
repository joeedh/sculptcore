...
static void posePre(CommandCtxBase &ctx, std::span<typename TYPES::node_type *> nodes)
{
...
template <CommandTypes TYPES>
static void posePost(CommandCtxBase &ctx, std::span<typename TYPES::node_type *> nodes)
{
  (void)ctx;
  (void)nodes;
}
...
inline void packPoseGpuUniforms(sculptcore::brush::Brush &brush, unsigned char *out)
{
  (void)brush;
  (void)out;
}
