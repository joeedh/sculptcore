...
static void grabPre(CommandCtxBase &ctx, std::span<typename TYPES::node_type *> nodes)
{
...
static void grab(CommandCtx<TYPES> &ctx)
{
...
template <CommandTypes TYPES>
static void grabPost(CommandCtxBase &ctx, std::span<typename TYPES::node_type *> nodes)
{
  (void)ctx;
  (void)nodes;
}
...
static void createGrabBrush(BrushCommandDef<CommandCtx<TYPES>> &def)
{
...
inline void packGrabGpuUniforms(sculptcore::brush::Brush &brush, unsigned char *out)
{
  (void)brush;
  (void)out;
}
