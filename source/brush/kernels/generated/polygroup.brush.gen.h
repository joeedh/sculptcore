...
static void polygroupPre(CommandCtxBase &ctx, std::span<typename TYPES::node_type *> nodes)
{
  ...
  static const sculptcore::brush::CaptureSaveDesc __fsaves[] = {
    {sculptcore::brush::CaptureField::No, nullptr, int(sculptcore::meshlog::NO)},
    {sculptcore::brush::CaptureField::Attr, "group", int((1 << (sculptcore::meshlog::CUSTOM_START + 0)))},
  };
...
template <CommandTypes TYPES>
static void polygroupPost(CommandCtxBase &ctx, std::span<typename TYPES::node_type *> nodes)
{
  (void)ctx; (void)nodes;
}
