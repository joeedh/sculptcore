...
static void createColorBrush(BrushCommandDef<CommandCtx<TYPES>> &def)
{
  ...
  def.uniforms.append(sculptcore::brush::BrushUniformManifestEntry{
      "brushColor", false, false, 0.0f, false, 0.0f, 0.0f});
  def.uniforms.append(sculptcore::brush::BrushUniformManifestEntry{
      "mixMode", false, false, 0.0f, false, 0.0f, 0.0f});
...
inline void packColorGpuUniforms(sculptcore::brush::Brush &brush, unsigned char *out)
{
  (void)brush;
  (void)out;
  std::memcpy(out + 80, &brush.brushColor, 16);
  std::memcpy(out + 96, &brush.mixMode, 4);
}
